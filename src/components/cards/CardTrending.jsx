...
const trending = filter === "home" ? defaultArticles.trending : articles;  
  ...
  return (
    <div className="card-trending-container flex lg:w-275 lg:h-34 h-auto lg:flex-row flex-col justify-between overflow-x-auto scrollbar overflow-y-hidden">
      <div className=" flex flex-col lg:flex-row justify-between gap-9 lg:h-34 h-auto">
      {trending.map((article, index) => (
        ...
        >
          ...
          <div className="text-trending-container flex flex-col justify-between w-50 h-34 ">
            <h1 className="number-card-trending  text-Soft-red font-bold text-[1.9rem] font-">{String(index + 1).padStart(2, "0")}</h1>
            <h4 className="trending-title font-primary text-Very-dark-blue dark:text-Off-white text-size-16 tracking-wide font-bold line-clamp-1">
              {article.title}.
            </h4>
